 # 1.2.5 The Final Design: A Team of Learning Agents
...
This Grandmaster Agent does only one thing: **It plays the game using the current evaluation function (V_hat).**


It looks at a board position, uses **V_hat** to score it, and picks the move that leads to the best next position. That is all. It does not know how to improve itself—other agents will take care of that.
...
**In Chess Terms:**
The Performance Agent plays the full game against itself. It generates a sequence of board positions by using the current evaluation function (**V_hat**) to choose moves.
...
* Improves the scoring function (**V_hat**).
...
**Result:**
Over time, the approximation (**V_hat**) becomes closer and closer to the true evaluation (**V**). The Grandmaster Agent becomes increasingly strong, just as a medical student becomes a skilled doctor after many surgeries, reviews, and corrections.
